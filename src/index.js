  ...
  $ = (e, t = {}, r) => {
    ...
    (process.on('SIGTERM', () => o('SIGTERM')),
      ...
      process.on('uncaughtException', s => {
        (r.error(s, `\u{1F4A5} \u672A\u6355\u83B7\u7684\u5F02\u5E38: ${s.message}`), process.exit(1));
      }),
      process.on('unhandledRejection', (s, n) => {
        (r.error({reason: s, promise: n}, '\u26A0\uFE0F \u672A\u5904\u7406\u7684 Promise \u62D2\u7EDD'),
          process.exit(1));
      }));
  },
...
var j = (e, t) => (r, o, s) => {
  ...
  H = (e, t) => (r, o, s, n) => {
    ...
    (t.error(
      ...
      s.status(i).json({success: !1, message: e.isDev ? a : p, stack: e.isDev ? r.stack : void 0, timestamp: d()}));
  };
...
var N =
  ...
  (t, r, o) => {
    ...
    let s = C(e.whiteAuthKeys);
    if (M(e.whitePathList, e.apiPrefix).includes(t.path)) return o();
    let {authToken: i, jwtConfig: a} = e;
    if (typeof i == 'string' && i.length > 0 && i !== 'false') {
      let m = t.headers,
        c = m['x-huxy-auth'] || m['x-api-key'] || m.authorization || '',
        l = t.query.token || c.split('Bearer ')[1];
...
var ae = ['referer', 'x-forwarded-for', 'x-real-ip', 'cf-connecting-ip', 'cf-ipcountry', 'cf-ray'],
  ce = ['x-powered-by', 'server'],
  A = (e, t) => {
    (ae.forEach(o => e.removeHeader(o)), e.setHeader('User-Agent', 'IHUXY-API/1.0'));
    let r;
    try {
      r = new URL(t);
    } catch {}
  ...
  U = e => {
    (ce.forEach(t => delete e.headers[t]),
      ...
      e.headers['content-type']?.includes('text/event-stream') &&
...
var le = (e, t = '/') => {
  ...
  me = ({target: e = 'http://', prefix: t, withPrefix: r, preserve: o = !1, ...s} = {}) => ({
    target: e,
    changeOrigin: !0,
    secure: !1,
    xfwd: !0,
    ...
    on: {
      ...
      error: (n, i, a) => {
        ...
        !p && !m && (a.headersSent || a.status(502).json({error: '\u7F51\u5173\u9519\u8BEF'}));
      },
    },
    ...s,
  }),
...
var he = {
    ...
    rateLimit: {
      ...
      limit: parseInt(process.env.RATE_LIMIT_MAX_REQUESTS || '200', 10),
      skip: e => {
...
var Ae = async (e, t = {}, r) => {
  ...
  Se = (e, t = {}, r, o) => {
    e.use(
      t.apiPrefix,
      ye({
        keyGenerator: n => xe(n.ip) || n.headers['x-huxy-auth'] || n.headers['x-api-key'] || n.headers.authorization,
        ...t.rateLimit,
      }),
    );
    let s = _(t);
  ...
  Te = (e, t = {}, r, o) => {
    (o && O(e, t), e.use(W(t)), e.use(j(t, r)), e.use(H(t, r)));
  },
  Ee = async (e = {}, t, r, o) => {
    ...
    p ?
      (h(p) ||
        (i.error(
          {ssl: {key: "readFileSync('./ssl/key.pem')", cert: "readFileSync('./ssl/cert.pem')"}},
          '\u26A0\uFE0F \u8BF7\u8BBE\u7F6E\u6709\u6548 SSL \u6216\u8BBE\u7F6E {ssl: false}',
        ),
        process.exit(1)),
      (n.protocol = 'https'),
      (l = we.createServer(p, c)),
      c.use((u, K, z) => {
        if (!u.secure) return K.redirect(301, 'https://' + u.headers.host + u.originalUrl);
        z();
      }))
    : (l = ve(c));
    ...
    if (v(r))
      try {
        ...
        (i.error({err: u}, `\u274C \u94A9\u5B50\u51FD\u6570\u9519\u8BEF\uFF1A${u.message}`), process.exit(1));
      }
    if ((o && Pe(c, f), Se(c, n, i, l), v(t)))
      try {
        await t(f, c, l, i);
      } catch (u) {
        (i.error({err: u}, `\u274C \u56DE\u8C03\u51FD\u6570\u9519\u8BEF\uFF1A${u.message}`), process.exit(1));
      }
    Te(c, f, i, o);
    try {
      (await L(l, f), k(f, i));
    } catch (u) {
      (i.error({err: u}, '\u26A0\uFE0F \u670D\u52A1\u5668\u542F\u52A8\u5931\u8D25\uFF01'), process.exit(1));
    }
    return ($(l, f, i), {config: f, app: c, httpServer: l, logger: i});
  },
  P = Ee;
var Ie = (e, t, r) => P(e, t, r),
  Tt = (e, t, r) => P(e, t, r, !0),
  Et = Ie;
export {Et as default, w as resolvePath, Ie as startServer, Tt as startStatic};
